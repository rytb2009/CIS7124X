...
import io.github.rytb2009.homework.BTNodeUtils;
...
class TestBTNodeUtils {
    ...
    void preorder() {
        ...
        List<Integer> bfsList = BTNodeUtils.preorder(node1);
        assertEquals(bfsList, new LinkedList<Integer>(){
            { add(20);add(10);add(5);add(6);add(3);add(1);add(2); }
        });
    }
    ...
    void level() {
        ...
        BTNode<Integer> node1RightRight = new BTNode<>(2);
        node1Right.setRight(node1RightRight);
        List<Integer> layerList = BTNodeUtils.level(node1, 3);
